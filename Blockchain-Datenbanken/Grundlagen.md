...
Ein anderes Argument, was dagegen spricht, ist die Transparenz, die gleichzeitig auch als Vorteil gesehen wurde. Da jeder Teilnehmer Auskunft über die Transaktionshistorie (vergangene, zukünftige) in jedem Knoten hat, könnte z.B. ein Wettbewerber die Preise einsehen. Damit würde die Privatsphäre betroffen sein, denn ein Teilnehmer könnte Ein- und Ausgaben eines anderen auslesen. Schließlich darf nicht außer gelassen werden, dass die Miners (s. Kapitel Proof of Work) viel Rechenleistung in Anspruch nehmen, um eine Transaktionsvalidierung zu ermöglichen. Das heißt, dass viel Stromverbrauch dafür benötigt wird. [08]
